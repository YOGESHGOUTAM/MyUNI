        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {docs.map((doc) => {
            ...
            return (
              <div
                key={doc.id}
                className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-sm overflow-hidden border border-slate-200/50 hover:shadow-md transition-all"
              >
                <div className="p-6">
                  {/* File Icon & Info */}
                  ...
                  <button
                    ...
                    className="bg-red-100/80 hover:bg-red-200/80 text-red-600 px-4 py-2.5 rounded-2xl w-full flex items-center justify-center gap-2 transition-all text-sm font-medium"
                  >
                    <Trash2 size={16} />
                    Delete
                  </button>
